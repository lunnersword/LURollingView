...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of LURollingView."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/LURollingView"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "bingchen" => "bingchen@kongge.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/LURollingView.git", :tag => s.version.to_s }
